...
struct Point {
	...
	/**
	*	Returns a Point with the x and y multiplied by -1 which is reversed
	*		@return a reversed point
	*/
	Point reverse();
};
...
public:
	/**
	*	Initializes a SpaceObject with a type of ASTEROID, a radius of 20, a position of (0, 0), a velocity of (0, 0), and an angle of 0ｰ
	*/
	SpaceObject();
	...
	*		@param angle - the angle of the object (defaults to 0ｰ if invalid.)
	*/
	...
	*		@return the number (int) of times that the object has been drawn
	*/
...
private:
	...
	int timesDrawn = 0; //the number of times the object has been drawn
};